...
const bays = [
  {
    ...
    note: "Drag to orbit · idle spin · hover lifts. Swap the placeholder for the Mist / Noir set GLB (gh3-clothing-optimizer keeps material zones).",
    Comp: GarmentViewer,
    height: "78vh",
  },
  {
    ...
    note: "Plaster + oak room, mouse parallax now. Wire to scroll (drei ScrollControls) or bake a fly-through in Theatre.js. Swap for your environment GLB.",
    Comp: StudioScene,
    height: "86vh",
  },
  {
    ...
    note: "Breathes and turns to face you. Swap for a CC5 avatar (cc5-avatar-pipeline-v2 + glb-cc5-optimizer for hair).",
    Comp: AvatarHero,
    height: "82vh",
  },
  {
    ...
    note: "Folded set · band · bottle, drifting with the cursor. Swap each for a small prop GLB. Lightest option.",
